...
export const metadata: Metadata = {
  title: 'About CodeMash — Free Online Developer Tools',
  description:
    'Learn about CodeMash — the free, fast, and privacy-first developer tools suite with 25+ tools including JSON formatter, XML converter, Base64 decoder, and more. Built by developers, for developers.',
  alternates: {
    canonical: '/about',
  },
};
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="prose dark:prose-invert max-w-none">
        <h2>Our Story</h2>
        <p>
          CodeMash started as a simple collection of data conversion tools
        ...
        <p>
          ...
          respect your privacy. That is why we built CodeMash to process
        ...
        <h2>Technology</h2>
        <p>
          CodeMash is built with modern web technologies for the best possible
          experience:
        </p>
        <ul>
