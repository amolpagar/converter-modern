...
export const metadata: Metadata = {
  title: 'Contact Us — CodeMash',
  description:
    'Get in touch with the CodeMash team. Report bugs, request new developer tools, suggest features, or ask questions.',
  alternates: {
    canonical: '/contact',
  },
};
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
        ...
        >
          ...
          <span className="text-sm text-gray-500 mt-1">hello@codemash.pro</span>
        </a>
        <a
        ...
        >
          ...
          <span className="text-sm text-gray-500 mt-1">@codemash</span>
        </a>
      </div>
